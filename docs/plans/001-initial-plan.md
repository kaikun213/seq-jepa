...
4. **LPL / ESPP / "Learning what matters" are real demonstrations that local/predictive/plasticity-inspired rules can produce invariances and work online** (in their respective settings). See references in Step 6 and `docs/reference/references.md`.
